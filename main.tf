...
resource "null_resource" "configure_nfs" {
        ...
        #private_key = "https://github.com/wasim30/Terraform/blob/main/Wasim-AWS-key.pem"
        private_key = var.ec2_keypair
...
resource "null_resource" "configure_nfs-b" {
        ...
        user     = "ec2-user"
        #private_key = file("/home/ec2-user/learn-terraform-aws-instance/Wasim-AWS-key.pem")
        #private_key = "https://github.com/wasim30/Terraform/blob/main/Wasim-AWS-key.pem"var.ec2_keypair
        private_key = var.ec2_keypair
